export default function GossipIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="25"
      height="25"
      ...
      {...props}
    >
      <rect width="25" height="25" fill="url(#pattern0_1_1385)" />
      <defs>
        <pattern
          id="pattern0_1_1385"
          ...
          height="1"
        >
          <use xlinkHref="#image0_1_1385" transform="scale(0.015625)" />
        </pattern>
        <image
          id="image0_1_1385"
          width="64"
